...
**Integer和Long的hashCode()方法实现有什么区别？**
    @Override
    public int hashCode() {
...
```
### 13.String，StringBuffer，StringBuilder的区别【6+】
...
```
### 18.什么是java序列化？什么情况下需要序列化？如何避免序列化对象中的属性序列化？【3+】
