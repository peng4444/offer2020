...
### 7.为什么重写equals时必须重写hashCode方法【4+】
```markdown
...
```
### 8.String，Stringbuffer，StringBuilder的区别【2+】
...
```
### 6.什么是java序列化？什么情况下需要序列化？如何避免序列化对象中的属性序列化？【1+】
...
```
### 12.NoClassDefFoundError和ClassNotFoundException区别【1+】
...
```
### 14.final, finally, finalize的区别【2+】
```markdown
...
```
### 15.try-catch-finally 语法块的执行顺序等问题【1+】
