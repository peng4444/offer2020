...
[谈谈 Java 中的那些“琐”事](https://www.cnblogs.com/songjilong/p/13710455.html)
```markdown
1、乐观锁
...
3、独享锁(也可称为写锁，只能被一个线程持有，synchronized和ReentrantLock都是独占锁)
...
### 12.ReentrantLock和synchronized之间的区别【10+】
