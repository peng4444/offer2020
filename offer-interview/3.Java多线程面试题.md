...
>> 22. synchronized用过么，具体用法，同步作用域
   ...
   synchronized锁升级过程
   sychronized怎么实现？monitor，monitor存在哪里？不知道。知道对象头吗？...
```markdown
...
synchronized则是锁定当前变量，只有当前线程可以访问该变量，其他线程被阻塞住。
    1.volatile只能用于变量，而synchronized可以修饰方法和代码块。
