...
## 20200902
### [20200901-拼多多]()
[4道全A）拼多多2021届提前批-服务端研发工程师笔试](https://zihao.blog.csdn.net/article/details/108350913)
[9-1拼多多题目，4题AK](https://www.cnblogs.com/hua-dong/p/13599577.html)
```markdown
...
## 20200903
### [0903百度笔试]()
[百度2021校招C++/PHP研发工程师笔试卷（9月3日）](https://www.nowcoder.com/discuss/498053)
### [虾皮9.2后端笔试编程题ak笔记](https://www.nowcoder.com/discuss/496328)
```markdown
题意：给定一个序列，要把这个序列变成一个数，每次将相邻两个数合成一个数，贡献为新合成的数，求最小贡献。
题意：给定一个字符串，将这个字符串变成两个以上相同字符串的拼接，只能在字符串的末尾补，问最少要补多少个字符。
题意：有两种东西，每种东西都有n个，每一次随机选一种东西它的数量减一，当选择的东西的数量为0，问另一个东西的数量的期望是多少。（期望向下取整）
```

## 20200904
### [B站后端开发笔试题0813](https://www.nowcoder.com/discuss/476293)
```markdown
LeetCode679
...
第三题：    public int GetCoinCount(int N) {
            N = 1024 - N;
            int count = 0;
            while (N > 0) {
                if (N >= 64) {
...
## 20200905
### [阿里笔试9.4](https://www.nowcoder.com/discuss/498406)
```markdown
...
坑点：可多次删除
```
###  [9-5 搜狗笔试 AK](https://blog.csdn.net/nimphy/article/details/108424445)
[2020.09.05 搜狗研发岗笔试 A~C题解](https://www.nowcoder.com/discuss/500256)
```markdown
第一题
题意：
...
## 20200906
### [美团点评 9月6日 笔经](https://www.nowcoder.com/discuss/500638)
[美团9.6开发笔试（C++，全AC）](https://www.nowcoder.com/discuss/500649)
[【美团&字节】四道编程题（思路）2020/09/06](https://blog.csdn.net/weixin_41896265/article/details/108435552)
## 20200907
[2020/9/5 18:30 搜狗自闭笔试题](https://www.nowcoder.com/discuss/500290)
[9.5搜狗测试笔试](https://www.nowcoder.com/discuss/500241)

## 20200909
### [携程研发笔试](https://www.nowcoder.com/discuss/503417)
```markdown
public class P1 {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
...
```
### [华为笔试9.3 AC3 Java](https://www.nowcoder.com/discuss/504784)
### [广联达9.9笔试]()
```markdown
public class Main1 {
    public static void main(String[] args) {
...
### [有赞]()
```markdown
1.项数相加  3,5  --> 3+33+333+3333+33333
public long sum (int num, int itemNum) {
    ...
    public long help(int num,int n){
        StringBuilder sb = new StringBuilder();
        for(int i = 1;i<=n;i++){
            sb.append(num);
        }
...
2.最小移动次数和leetcode462
```

## 20200913
### [网易2021批笔试题解](https://blog.csdn.net/qq_38649940/article/details/108551501)
### [网易有道9.12笔试（移动开发）](https://www.nowcoder.com/discuss/508509)
### [科大讯飞正式批笔试](https://www.nowcoder.com/discuss/508405)
### [9.13滴滴&度小满编程题](https://www.nowcoder.com/discuss/509304)
```markdown
滴滴第一题:
...
```
### [美团9.13技术类编程题](https://www.nowcoder.com/discuss/508772)
### [新浪9.13笔试](https://www.nowcoder.com/discuss/509108)
## 20200915
### [58同城笔试原题+AC代码](https://www.nowcoder.com/discuss/510837)

## 20200916
### [金山云Java方向9.16笔试](https://www.nowcoder.com/discuss/513411)
### [最右笔试9.10 Java 2AC](https://www.nowcoder.com/discuss/506038)

## 20200917
### [9.14 58同城投票加3AC](https://www.nowcoder.com/discuss/510555)

## 20200918
### [京东笔试9.17 Java](https://www.nowcoder.com/discuss/515020 )