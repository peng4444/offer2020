...
```
#### 5.Sorted Set有序集合终端命令、内部编码及应用场景
```markdown
...
```
### 6.Redis持久化机制【10+】
[Redis 持久化之 RDB 与 AOF 详解](https://www.cnblogs.com/jojop/p/13941195.html)
```markdown
